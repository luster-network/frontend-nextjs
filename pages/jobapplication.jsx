...
import ApplyJobLoading from '../components/applyJob/applyJobLoading';
...
const ApplyJob = () => {
  ...
  const {id:jobid, type:jobtype} = router.query;
  ...
  const jobAPI = `${process.env.NEXT_PUBLIC_ENDPOINT}/api/v1/jobs/`;
  const internAPI = `${process.env.NEXT_PUBLIC_ENDPOINT}/api/v1/internship/`;
          ...
          <div className='mt-3'>
            {
              ...
              <>
                <button onClick={() => {
                  router.push(`/auth/devlogin?redirectid=${jobid}&redirecttype=${jobtype}`)
