...
const Landing = () => {
  return (
    ...
    <div className='background px-12 h-[100rem] mt-44 md:mt-12 md:h-[40rem] flex flex-col items-center justify-center'>
        <div className='flex mb-8 md:flex-row'>
          <p className='text-[#003979] text-xl m-0 mr-2 md:text-[55px] font-bold'>Solana</p>
          <p className='text-[#006DF6] text-xl m-0 md:text-[55px] font-bold'>Blockchain</p>
        </div>
        <div>
          <p className='text-3xl md:text-[60px] m-0 md:mb-6 font-bold'>Development Bootcamp </p>
        </div>
            <p className='mt-8 md:text-xl'>We are on the mission to upskill 1M+ Web3 enthusiasts to Web3 developers by 2025</p>
    ...
    <div className='flex flex-col border-3 items-center text-center justify-center py-12'>
      ...
      <a href="https://calendly.com/cryptonaukri/pradnyashil" target="_blank" className='border-2 mt-1 border-[#003979] text-[#003979] font-semibold rounded-md px-12 py-2 inline-block hover:bg-[#003979] hover:text-white hover:cursor-pointer'>Schedule now !</a>
    </div>
