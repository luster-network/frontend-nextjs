...
const ProjectLoadingCard =()=>{
  return(
    <div className="px-2 mt-3 mb-2 animate-pulse">
      <div className="w-1/4 h-5 bg-indigo-900 rounded-sm"></div>
      <div className="w-1/5 h-4 mt-1 bg-indigo-900 rounded-sm"></div>
      <div className="h-9 mt-1 bg-indigo-900 rounded-sm pb-2"></div>
...
const SideProfile = (props) => {
  ...
  return (
    <div className="shadow-lg shadow-indigo-600 p-2 rounded h-screen">
      <div className="flex justify-center  items-center">
        {/* <FiGithub />  */}
        <span className="ml-2">Your <span className="underline underline-offset-4 ">GitHub</span> Projects</span>
      </div>
              ...
              <div className="p-2 border-b mb-2">
                ...
                <div className="flex justify-between">
                  <div className="flex items-center">
                    <BiGitRepoForked className=""/> <span className=" text-sm mr-2">{project.forks}</span>
                    <AiOutlineStar className=""/> <span className=" text-sm">{project.stars}</span>
                  </div>
                  <div className="flex items-center">
                    {
                      project.website === undefined ? null :
                      <a href={project.website}><RiLinksFill className=""/></a>
                    }
                    <a href={project.link} className="ml-2"><FiGithub className=""/></a>
                  </div>
                </div>
