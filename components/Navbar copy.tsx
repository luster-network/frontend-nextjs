...
const Navbar = () => {
  ...
  return (
    <div className='flex h-24 py-8 px-8 md:px-24 items-center flex-row justify-between'>
      ...
      <div className='md:flex hidden items-center flex-row justify-between'>
        <Link href='/' className='mr-8 text-xl relative group'>
          <span>Home</span>
        ...
        <Link href='/aboutus' className='mr-8 text-xl relative group'>
          <span>About us</span>
          <span className="absolute -bottom-1 left-1/2 w-0 h-[2px] bg-[#016BF0] group-hover:w-1/2 group-hover:transition-all"></span>
          <span className="absolute -bottom-1 right-1/2 w-0 h-[2px] bg-[#016BF0] group-hover:w-1/2 group-hover:transition-all"></span>
        </Link>

        <Link href='/#faq' className='mr-8 text-xl relative group'>
          <span>Naukri hub</span>
          <span className="absolute -bottom-1 left-1/2 w-0 h-[2px] bg-[#016BF0] group-hover:w-1/2 group-hover:transition-all"></span>
          <span className="absolute -bottom-1 right-1/2 w-0 h-[2px] bg-[#016BF0] group-hover:w-1/2 group-hover:transition-all"></span>
        </Link>

        <Link href='/#panelist' className='mr-8 text-xl relative group'>
          <span>Community</span>
          <span className="absolute -bottom-1 left-1/2 w-0 h-[2px] bg-[#016BF0] group-hover:w-1/2 group-hover:transition-all"></span>
          <span className="absolute -bottom-1 right-1/2 w-0 h-[2px] bg-[#016BF0] group-hover:w-1/2 group-hover:transition-all"></span>
        </Link>

        <Link href='/contact' className='mr-8 text-xl relative group'>
          <span>Contact</span>
          <span className="absolute -bottom-1 left-1/2 w-0 h-[2px] bg-[#016BF0] group-hover:w-1/2 group-hover:transition-all"></span>
          <span className="absolute -bottom-1 right-1/2 w-0 h-[2px] bg-[#016BF0] group-hover:w-1/2 group-hover:transition-all"></span>
        </Link>
      ...
      <div className='md:hidden relative'>
        ...
        <Link href='/aboutus' className='mr-8 relative group'>
          <span>About us</span>
          <span className="absolute -bottom-1 left-1/2 w-0 h-[2px] bg-[#016BF0] group-hover:w-1/2 group-hover:transition-all"></span>
          <span className="absolute -bottom-1 right-1/2 w-0 h-[2px] bg-[#016BF0] group-hover:w-1/2 group-hover:transition-all"></span>
        </Link>
        ...
        <Link href='/contact' className='mr-8 relative group'>
          <span>Contact</span>
          <span className="absolute -bottom-1 left-1/2 w-0 h-[2px] bg-[#016BF0] group-hover:w-1/2 group-hover:transition-all"></span>
          <span className="absolute -bottom-1 right-1/2 w-0 h-[2px] bg-[#016BF0] group-hover:w-1/2 group-hover:transition-all"></span>
        </Link>
