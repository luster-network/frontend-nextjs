...
const EditResume = ({token, user}) =>{
    ...
    return (
        <>
            <button className="bg-gray-600 hover:bg-gray-800 rounded p-1 text-xs text-center w-full mt-1" onClick={()=>setOpenEditProfile(true)}>Edit Profile</button>
                ...
                <div className="bg-gray-300 h-min border rounded-md mt-32 p-2 mx-4 flex flex-col w-full sm:w-1/2">
                    ...
                    className="px-1 mt-2" >
                        <div className="flex flex-col">
                            <label className="pl-1 text-base mb-1 text-gray-700">First Name</label>
                            <input type="text"
                        ...
                        <div className="mt-2 flex flex-col">
                            <label className="pl-1 text-base mb-1 text-gray-700">Last Name</label>
                            <input type="text"
                                className="px-2 text-sm text-gray-300 bg-gray-700 w-full h-10 focus:outline-none rounded"
                                value={lastName}
                        ...
                        <div className="mt-2 flex flex-col">
                            <label className="pl-1 text-base mb-1 text-gray-700">Phone Number</label>
                            <input type="text"
                                className="px-2 text-sm text-gray-300 bg-gray-700 w-full h-10 focus:outline-none rounded"
                                value={phoneNumber}
                        ...
                        <div className="mt-2 flex flex-col">
                            <label className="pl-1 text-base mb-1 text-gray-700">Location</label>
                            <input type="text"
                                className="px-2 text-sm text-gray-300 bg-gray-700 w-full h-10 focus:outline-none rounded"
                                value={location}
